...
class SumSquareDifference(unittest.TestCase):
    def test_sum_of_the_squares_of_integers_returns_the_sum(self):
        total = sum_square_difference.sum_of_the_squares([1, 2, 3])
    ...
    def test_returns_the_sum_of_squares_minus_square_of_sum(self):
        difference = sum_square_difference.calculate(3)
